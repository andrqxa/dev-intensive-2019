...
class CircleImageView @JvmOverloads constructor(
    ...
    private var borderWidth = Utils.dp2Pixels(context, 2F)
    ...
    fun getBorderWidth(): Int = Utils.pixels2Dp(context, borderWidth)

    fun setBorderWidth(dp: Int) {
        borderWidth = Utils.dp2Pixels(context, dp.toFloat())
        this.invalidate()
    }
